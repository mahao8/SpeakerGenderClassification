...
LIBRISPEECH_DIR = DATA_DIR + "Train/"
#SPEAKERS_FILE = LIBRISPEECH_DIR + "DOC/SPEAKERS.TXT"  # The speakers file containing the gender infos
SPEAKERS_FILE = LIBRISPEECH_DIR + "DOC/SPKRINFO.TXT"  # The speakers file containing the gender infos
#AUDIO_FILES_DIR = LIBRISPEECH_DIR + "dev-clean/"
AUDIO_FILES_DIR = LIBRISPEECH_DIR + ""
#AUDIO_EXT = "flac"
TEMP_WAV = "temp.WAV"
AUDIO_EXT = "WAV"
AUDIO_EXT_FLAC = "flac"
